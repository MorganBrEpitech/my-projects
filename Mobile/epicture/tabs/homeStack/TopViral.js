...
export default function SettingsMenu({ navigation }) {
  ...
  useEffect(() => {     //C'est un hook, ça lance la fonction dès que les components sont chargés
    fetch('https://api.imgur.com/3/gallery/hot/viral/0.json', {headers:{'Authorization': 'Client-ID 1fbdce43e06d6a9'}})   //le '.json' est optionnel
  ...
  >
    ...
    <ScrollView>
      <View style={styles.titlecontainer}>
        <Text style={styles.title}>Top Viral Galleries</Text>
      </View>
