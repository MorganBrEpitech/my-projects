<header class="header mb-5">
    <div class="header__band d-none d-md-block <?= (isset($_SESSION['username'])) ? 'header__band--bigger' : '' ?>">
        <?php if(isset($_SESSION['username'])) {
            echo '<div id="block_container"><div class="avatar-container avatar-size"><img src="avatar1.jpg" class="avatar-image" /></div><div class="container"><span class="w-100 d-inline-block text-white text-end">Bonjour ' . $_SESSION['username'] .' ! Vous êtes connecté(e)</span></div></div>';
        } ?>
    </div>
